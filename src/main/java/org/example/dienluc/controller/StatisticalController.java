...
public class StatisticalController {
    ...
    @GetMapping("/consumption-electric-types/fix")
    ...
    @PostMapping("/consumption-by-year")
    public ResponseEntity<?> getConsumptionByYear(@RequestBody ConsumptionByYear consumptionByYear) {
        ResponseData responseData = ResponseData.builder()
                .data(statisticalService.getConsumptionByYear(consumptionByYear))
                .message("get getConsumptionByYear")
                .status(HttpStatus.OK.value())
                .build();
        return ResponseEntity.ok(responseData);
    }
    ...
    public ResponseEntity<?> getRevenueByYear(@RequestBody RevenueByYearDto revenueByYearDto) {
        ResponseData responseData = ResponseData.builder()
                .data(statisticalService.getRevenueByYear(revenueByYearDto))
                .message("get getConsumptionByYear")
                .status(HttpStatus.OK.value())
                .build();
        return ResponseEntity.ok(responseData);
